...
@section('title', trans('admin.order-item.actions.index'))

@section('body')

    <order-item-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/order-items') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.order-item.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/order-items/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.order-item.actions.create') }}</a>
                    </div>
