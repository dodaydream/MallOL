<div class="form-group row align-items-center" :class="{'has-danger': errors.has('promote_price'), 'has-success': fields.promote_price && fields.promote_price.valid }">
    <label for="promote_price" class="col-form-label" :class="isFormLocalized ? 'col-md-12' : 'col-md-12'">{{ trans('admin.product.columns.promote_price') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-12'">
